...
DBCC CHECKIDENT('programming_languages', RESEED, 0)   
...
DBCC CHECKIDENT('submit', RESEED, 0)   
DBCC CHECKIDENT('tests', RESEED, 0)   
DBCC CHECKIDENT('tips', RESEED, 0)   
DBCC CHECKIDENT('decrease_function', RESEED, 0)
...
(fuction_name, coefficients, users_user_id)
VALUES
('spadek1', '<polynomial><degree>3</degree><coeff>1</coeff><coeff>0</coeff><coeff>-3</coeff><coeff>2</coeff></polynomial>', 1)-- ,
INSERT INTO decrease_function
(fuction_name, coefficients, users_user_id)
VALUES
('spadek2', '<polynomial><degree>1</degree><coeff>1</coeff><coeff>-1</coeff></polynomial>', 2)
INSERT INTO decrease_function
(fuction_name, coefficients, users_user_id)
VALUES
('spadek3', '<polynomial><degree>3</degree><coeff>1</coeff><coeff>0</coeff><coeff>-3</coeff><coeff></coeff></polynomial>', 1)
